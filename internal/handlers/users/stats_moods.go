...
func (u UserHandler) GetRecentMoods(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	response.SuccessResponse(w, "mood stats retrieved successfully", ToStatsMoodPagedDTO(metrics))
}

...
func (u UserHandler) GetRecentSleepQualityStats(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	response.SuccessResponse(w, "sleep quality stats retrieved successfully", ToStatsSleepQualityPagedDTO(metrics))
}
